...
(() => searchForFiles('./', /\.html$/, filename => {
  ...
  JSDOM.fromFile(filename).then(dom => {
    ...
    try {
      doc.save(`${rootFolder}${rootFolder.replace('/Users/damianwhyte/Desktop/Projects/Unused-images-removal-tool/', '').replaceAll('/', '_')}iPadPro_Q221_Web_Marketing_Page_CopyDeck.pdf`)
